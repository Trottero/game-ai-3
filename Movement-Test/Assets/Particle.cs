...
public class Particle : MonoBehaviour
{
    ...
    public MeshCollider EnvironmentCollider;
    ...
    void Start()
    {
        ...
        EnvironmentCollider = EnvironmentCollider == null ? GameObject.Find("BoundingBox").GetComponent<MeshCollider>() : EnvironmentCollider;
